...
import com.ragas.springboot.SurveyApiApplication;
...
@SpringBootTest(classes = SurveyApiApplication.class, webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT)
public class SurveyControllerIT {
	...
	private String createHttpAuthenticationHeaderValue(final String userId, final String password) {
